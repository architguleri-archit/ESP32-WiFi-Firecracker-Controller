# Wi-Fi Firecracker Controller Using ESP32

This project demonstrates a **Wi-Fi based firecracker controller using ESP32**, controlled directly from a **smartphone browser** using a web interface.  
No mobile app is required — just open the ESP32 IP address in your browser.
...
- Smartphone control via browser  
- ESP32 built-in Wi-Fi  
- Relay-based triggering system  
- ARM / FIRE safety logic  
